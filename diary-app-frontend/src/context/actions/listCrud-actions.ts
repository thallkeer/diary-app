import { IEntity, IListItem, IListWithItems } from "../../models/entities";
...
export const getListItemActions = <TListItem extends IListItem>(
	listItemName: ListItemUrls
) => {
	console.log("get list item actions is called", listItemName);

	const crudService = new CrudService<TListItem>(listItemName);
